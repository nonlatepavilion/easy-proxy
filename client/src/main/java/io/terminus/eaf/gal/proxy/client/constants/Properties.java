package io.terminus.eaf.gal.proxy.client.constants;
...
public class Properties {
	 ...
	 * 
	 */
	public final static int ClientSocketReadTimeout = 10 * 1000;
	 ...
	 * 
	 */
	public final static int ServerConnectTimeout = 15 * 1000;
